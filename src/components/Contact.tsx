...
import { Mail, Share2, Send, MessageSquare } from "lucide-react";

// --- CUSTOM SVG COMPONENTS (Fixing missing library icons) ---
    ...
    <section id="contact" className="w-full min-h-screen relative overflow-hidden bg-black flex items-center justify-center px-6 py-24">
      ...
      <div className="max-w-6xl w-full grid md:grid-cols-2 rounded-[2.5rem] overflow-hidden border border-white/5 shadow-2xl relative z-10 bg-zinc-900/20 backdrop-blur-xl">
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
          className="p-12 lg:p-16 bg-zinc-900/40"
        >
          <form className="space-y-8">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-4 rounded-2xl bg-sky-500 text-black font-bold flex items-center justify-center gap-3 hover:bg-sky-400 transition-all group"
            >
              Send Message 
